...
import { ShellyPlatformAccessory } from './platformAccessory.js';
...
export class ShellyPlatform implements DynamicPlatformPlugin {
  /**
   * Configuration options for this platform
   */
  ...
  discoverDevices() {
    ...
    for (const device of devices) {
      ...
      if (existingAccessory) {
        ...
        new ShellyPlatformAccessory(this, existingAccessory);
        ...
        // this is imported from `platformAccessory.ts`
        new ShellyPlatformAccessory(this, accessory);
